...
countries = ['Albania', 'Algeria', 'Argentina', 'Armenia', 'Australia', 'Austria', 'Azerbaijan', 'Belarus', 'Belgium', 'Bosnia and Herzegovina', 'Brazil', 'Bulgaria', 'Cameroon', 
            ...
            'Portugal', 'Qatar', 'Romania', 'Russian Federation', 'San Marino', 'Saudi Arabia', 'Senegal', 'Serbia', 'Slovakia', 'Slovenia', 'South Africa', 
...
file_csv = "teams_info.csv"

with open(file_csv, 'w', newline='') as csv_file:
    csv_writer = csv.writer(csv_file)
    csv_writer.writerow(["Team Name", "Position", "Skill"])  # Nagłówki kolumn
    
    for team_name in teams:
        team_players = generate_team_players()
        for player in team_players:
            csv_writer.writerow([team_name, player.position, player.skill])
